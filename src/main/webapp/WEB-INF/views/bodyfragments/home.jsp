		...
		<div class="row">
			<div class="col-md-4 col-sm-6 portfolio-item">
				<a href="#portfolioModal1" class="portfolio-link"
					...
					</div> <img src="/HelloSpring/resources/img/portfolio/roundicons.png" class="img-responsive"
					alt="">
				</a>
			...
			<div class="col-md-4 col-sm-6 portfolio-item">
				<a href="#portfolioModal2" class="portfolio-link"
					...
					</div> <img src="/HelloSpring/resources/img/portfolio/startup-framework.png"
			...
			<div class="col-md-4 col-sm-6 portfolio-item">
				<a href="#portfolioModal3" class="portfolio-link"
					...
					</div> <img src="/HelloSpring/resources/img/portfolio/treehouse.png" class="img-responsive"
					alt="">
				</a>
				<div class="portfolio-caption">
					<h4>Treehouse</h4>
			...
			<div class="col-md-4 col-sm-6 portfolio-item">
				<a href="#portfolioModal4" class="portfolio-link"
					...
					</div> <img src="/HelloSpring/resources/img/portfolio/golden.png" class="img-responsive" alt="">
				</a>
				<div class="portfolio-caption">
					<h4>Golden</h4>
					<p class="text-muted">Website Design</p>
			...
			<div class="col-md-4 col-sm-6 portfolio-item">
				<a href="#portfolioModal5" class="portfolio-link"
					...
					</div> <img src="/HelloSpring/resources/img/portfolio/escape.png" class="img-responsive" alt="">
				</a>
				<div class="portfolio-caption">
					<h4>Escape</h4>
					<p class="text-muted">Website Design</p>
			...
			<div class="col-md-4 col-sm-6 portfolio-item">
				<a href="#portfolioModal6" class="portfolio-link"
					...
					</div> <img src="/HelloSpring/resources/img/portfolio/dreams.png" class="img-responsive" alt="">
				</a>
				<div class="portfolio-caption">
					<h4>Dreams</h4>
					<p class="text-muted">Website Design</p>
				...
				<ul class="timeline">
					<li>
						<div class="timeline-image">
							<img class="img-circle img-responsive" src="/HelloSpring/resources/img/about/1.jpg"
								alt="">
						</div>
					...
					<li class="timeline-inverted">
						<div class="timeline-image">
							<img class="img-circle img-responsive" src="/HelloSpring/resources/img/about/2.jpg"
								alt="">
						</div>
						<div class="timeline-panel">
							<div class="timeline-heading">
					...
					<li>
						<div class="timeline-image">
							<img class="img-circle img-responsive" src="/HelloSpring/resources/img/about/3.jpg"
								alt="">
						</div>
						<div class="timeline-panel">
							<div class="timeline-heading">
					...
					<li class="timeline-inverted">
						<div class="timeline-image">
							<img class="img-circle img-responsive" src="/HelloSpring/resources/img/about/4.jpg"
								alt="">
						</div>
						<div class="timeline-panel">
							<div class="timeline-heading">
		...
		<div class="row">
			<div class="col-sm-4">
				<div class="team-member">
					<img src="/HelloSpring/resources/img/team/1.jpg" class="img-responsive img-circle" alt="">
					<h4>Kay Garland</h4>
			...
			<div class="col-sm-4">
				<div class="team-member">
					<img src="/HelloSpring/resources/img/team/2.jpg" class="img-responsive img-circle" alt="">
					<h4>Larry Parker</h4>
			...
			<div class="col-sm-4">
				<div class="team-member">
					<img src="/HelloSpring/resources/img/team/3.jpg" class="img-responsive img-circle" alt="">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<a href="#"> <img src="/HelloSpring/resources/img/logos/envato.jpg"
					class="img-responsive img-centered" alt="">
				</a>
			</div>
			<div class="col-md-3 col-sm-6">
				<a href="#"> <img src="/HelloSpring/resources/img/logos/designmodo.jpg"
					class="img-responsive img-centered" alt="">
				</a>
			</div>
			<div class="col-md-3 col-sm-6">
				<a href="#"> <img src="/HelloSpring/resources/img/logos/themeforest.jpg"
					class="img-responsive img-centered" alt="">
				</a>
			</div>
			<div class="col-md-3 col-sm-6">
				<a href="#"> <img src="/HelloSpring/resources/img/logos/creative-market.jpg"
					class="img-responsive img-centered" alt="">
				</a>
			</div>
		</div>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<img class="img-responsive img-centered"
								src="/HelloSpring/resources/img/portfolio/roundicons-free.png" alt="">
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<p class="item-intro text-muted">Lorem ipsum dolor sit amet
								consectetur.</p>
							<img class="img-responsive img-centered"
								src="/HelloSpring/resources/img/portfolio/startup-framework-preview.png" alt="">
							<p>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<p class="item-intro text-muted">Lorem ipsum dolor sit amet
								consectetur.</p>
							<img class="img-responsive img-centered"
								src="/HelloSpring/resources/img/portfolio/treehouse-preview.png" alt="">
							<p>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<p class="item-intro text-muted">Lorem ipsum dolor sit amet
								consectetur.</p>
							<img class="img-responsive img-centered"
								src="/HelloSpring/resources/img/portfolio/golden-preview.png" alt="">
							<p>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<p class="item-intro text-muted">Lorem ipsum dolor sit amet
								consectetur.</p>
							<img class="img-responsive img-centered"
								src="/HelloSpring/resources/img/portfolio/escape-preview.png" alt="">
							<p>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<p class="item-intro text-muted">Lorem ipsum dolor sit amet
								consectetur.</p>
							<img class="img-responsive img-centered"
								src="/HelloSpring/resources/img/portfolio/dreams-preview.png" alt="">
							<p>
